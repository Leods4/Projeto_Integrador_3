  ...
  <header>
    ...
    <div class="right">
      <a href="/sistema_certificados/config/Router.php?rota=logout">
        <img src="../public/logout-icon.png" alt="Sair" class="logout-icon"> Sair
      </a>
    </div>
  </header>
  
  <div class="section-header">
    <form class="filters" method="POST" action="/sistema_certificados/config/Router.php?rota=filtrar">
