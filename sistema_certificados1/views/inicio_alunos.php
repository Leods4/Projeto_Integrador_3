...
<body>
  <header>
    <div class="left">
        <a href="/sistema_certificados1/config/Router.php?rota=inicio" style="color: black; text-decoration: none;"> Início</a>
    </div>
  ...
  <main>
    <div class="card-container">
      ...
      <div class="card">
        <img src="/sistema_certificados1/public/icon-cadastrar.png" alt="Cadastrar Horas" />
        <button class="btn" onclick="location.href='/sistema_certificados1/config/Router.php?rota=cadastro'">Cadastrar Horas Complementares</button>
      </div>
