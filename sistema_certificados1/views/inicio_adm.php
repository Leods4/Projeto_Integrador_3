...
<body>
  <header>
    <div class="left">
        <a href="/sistema_certificados1/config/Router.php?rota=inicio" style="color: black; text-decoration: none;"><img src="/sistema_certificados1/public/home-icon.png" alt="Home" class="home-icon"> Início</a>
    </div>
