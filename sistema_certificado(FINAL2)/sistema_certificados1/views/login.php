...
<head>
  ...
  <link rel="stylesheet" href="/sistema_certificados1/public/login.css" />
...
<body>
  ...
  <main>
    <div class="login-box">
      ...
      <img src="/sistema_certificados1/public/logo.png" alt="Logo FMP" class="logo" />
      ...
      <form action="/sistema_certificados1/config/Router.php?rota=login_in" method="POST">
